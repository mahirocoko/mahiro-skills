...
- do not treat a hidden matcher result as complete project configuration; generated rules must require the effective denies to be visible in project `settings.yml`
