...
describe("install", () => {
  ...
  test("surfaces bundle description when installing the default bundle", () => {
    ...
    try {
      ...
      expect(result.installed).toEqual(["asset-designer", "deep-research", "direct-cli", "forward", "gemini", "learn", "mahiro-docs-rules-init", "mahiro-guidance-refine", "mahiro-style", "philosophy", "project", "recap", "rrr", "uncodixify", "web-asset-prompts", "watch"]);
