...
describe("install", () => {
  ...
  test("surfaces bundle description when installing the default bundle", () => {
    ...
    try {
      ...
      expect(result.installed).toEqual(["asset-designer", "cocoindex-rules-init", "codex-asset-production", "control-room-goals", "direct-cli", "forward", "gemini", "learn", "mac-calendar-booking", "mahiro-docs-rules-init", "mahiro-guidance-refine", "mahiro-style", "philosophy", "project", "recap", "rrr", "sprite-workflow", "uncodixify", "web-asset-prompts", "watch"]);
