...
describe("README", () => {
  ...
  test("documents install and usage truthfully without public-page noise", () => {
    ...
    expect(content).toContain("curl -fsSL https://raw.githubusercontent.com/mahirocoko/mahiro-skills/main/install.sh | bash -s -- --version v0.1.60 -- --agent opencode --scope global");
