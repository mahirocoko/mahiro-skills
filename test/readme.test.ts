...
describe("README", () => {
  ...
  test("documents curl install and local checkout usage truthfully", () => {
    ...
    expect(content).toContain("curl -fsSL https://raw.githubusercontent.com/mahirocoko/mahiro-skills/main/install.sh | bash -s -- --version v0.1.21 -- --agent opencode --scope global");
