...
| `commands-gemini/gemini.toml` | native Gemini command | tests Gemini command installation pathing |
...
- `commands-gemini/gemini.toml` is also planned because the adapter supports commands
